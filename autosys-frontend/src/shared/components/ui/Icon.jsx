const PATHS = {
  ...
  car:      <><path d="M5 17H3a1 1 0 01-1-1v-5L5 7h14l3 4v5a1 1 0 01-1 1h-2"/><circle cx="7.5" cy="17" r="1.5"/><circle cx="16.5" cy="17" r="1.5"/><path d="M5 11h14"/></>,
  phone:    <><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.63A2 2 0 012 1h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></>,
  ...
  dl:       <><polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.11"/></>,
  ...
  trophy:   <><path d="M6 9H4a2 2 0 01-2-2V5a2 2 0 012-2h2M18 9h2a2 2 0 002-2V5a2 2 0 00-2-2h-2M8 21h8M12 17v4M6 9a6 6 0 0012 0V3H6v6z"/></>,
...
/**
 * Icon component — renders an SVG icon from the library.
 *
 * @param {string}  name  - Icon key (e.g. 'car', 'dashboard')
 ...
 */
export function Icon({ name, size = 16, color = 'currentColor', fill = 'none', className = '', style = {} }) {
